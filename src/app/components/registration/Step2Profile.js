...
const Step2Profile = () => {
  ...
  const validateTag = (value) => {
    ...
    if (!isValid) {
      dispatch(setValidationError({ step: 2, field: "tag", message }));
    } else {
      ...
      <div className={styles.fieldsContainer}>
        <div className={styles.fieldGroup}>
          <InputField
            ...
            error={validation.step2.tag.message}
        ...
        <InputField
          ...
          error={validation.step2.phone.message}
        ...
        <InputField
          ...
          error={validation.step2.description.message}
